        ...
        return (
            <div>
                { this.state.site && <div>
                    ...
                    <div>
                        <h3>Domains <span className="btn btn-primary" onClick={() => this.addDomain()}>Add domain</span></h3>
                    ...
                    <div>
                        <h3>Paths <span className="btn btn-primary" onClick={() => this.addPath()}>Add domain</span></h3>
